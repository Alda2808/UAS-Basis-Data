...
<body>
    ...
    <main class=" d-flex">
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-purple" style="width: 280px;">
            <center>
      ...
      <br>
                ...
                <li>
                    <a href="view_jadwal.php" class="nav-link">
                        <svg class="bi me-2" width="16" height="16">
        ...
        <div class="container-fluid">
            <div class="container bg-sidebar mt-2">
                <nav class="navbar bg-blue">
                    <a class="close">
                        <a href="view_jadwal.php"><img  src="close-removebg-preview.png" width="50px" height="30px"></a>
                </nav>
                <!-- box list -->
                        ...
                        <div class="container">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title"> Edit Jadwal Mata Kuliah</h5>
                                </div>
                                <div class="card-body">
                                <?php
							...
							$id = $_GET['id'];
							$sql = mysqli_query($connect, "SELECT * FROM db_add_jadwal WHERE id='$id'");
							while ($db_add_jadwal = mysqli_fetch_array($sql)) {
							?>
                                    <form action="ctrl_editjd.php" method="POST">
                                    <input name="id" value="<?php echo $db_add_jadwal ['id']; ?>" hidden />
                                        <div class="my-3">
                                            <label for="text1" class="form-label">Hari</label>
                                            <input class="form-control" id="text3" type="text" name="hari" value="<?php echo $db_add_jadwal ['hari']; ?>" />
                                        </div>
                                        <div class="my-3">
                                            <label for="text1" class="form-label">Waktu</label>
                                            <input class="form-control" id="text3" type="text" name="waktu" value="<?php echo $db_add_jadwal ['waktu']; ?>" />
                                        </div>
                                        <div class="mb-3">
                                            <label for="text3" class="form-label">Ruang</label>
                                            <textarea type="text" class="input form-control" style="height: 125px;"
                                                rows="3" name="deskripsi" ><?php echo $db_add_jadwal ['ruang']; ?></textarea>
                                        </div>
                                        <div class="mb-3">
                                            <label for="text1" class="form-label">Mata Kuliah</label>
                                            <input class="form-control" id="text3" type="text" name="matkul" value="<?php echo $db_add_jadwal ['matkul']; ?>" />
                                        </div>
                                        <div class="mb-3">
                                            <label for="text3" class="form-label">Program Studi</label>
                                            <input class="form-control" id="text3" type="text" name="prodi" value="<?php echo $db_add_jadwal ['prodi']; ?>"/>
                                        </div>
