    ...
    <main class=" d-flex">
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-purple" style="width: 280px;">
            ...
            <li>
                ...
                <li>
                    <a href="add_rps.php" class="nav-link">
                        <svg class="bi me-2" width="16" height="16">
        ...
        <div class="container-fluid">
            <div class="container bg-sidebar mt-2">
                ...
                <h4 class="text-white" style="margin-left: 10px;">Create RPS</h4>
                </nav>
                <!-- box list -->
                                ...
                                <div class="card-body">
                                    <form action="ctrl_add.php" method="POST">
                                        ...
                                        <div class="my-3">
                                            ...
                                            <input class="form-control" id="text3" type="text" name="kode" />
                                        </div>
                                        <div class="mb-3">
                                            <label for="text3" class="form-label">Mata Kuliah</label>
                                            <input class="form-control" id="text3" type="text" name="mata_kuliah" />
                                        </div>
                                        <div class="mb-3">
                                            <label for="sel1">SKS</label>
                                            <input class="form-control" id="text3" type="text" name="sks" />
                                        </div>
                                        <div class="mb-3">
                                            <label for="text3" class="form-label">Deskripsi</label>
                                            <textarea type="text" class="input form-control" style="height: 125px;"
                                                rows="3" name="deskripsi_matkul"></textarea>
                                        </div>
                                        <div class="mb-3">
