                    ...
                    <div id="headerrps" class="container tab-pane active"><br>
                        <div class="container">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="ctrl_add_jd.php" method="POST">
                                        <div class="my-3">
                                            <label for="text1" class="form-label">Hari</label>
                                            <input class="form-control" id="text3" type="text" name="hari" />
                                        </div>
                                        <div class="my-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" id="text3" type="text" name="ruang" />
                                        </div>
                                        <div class="mb-3">
                                            <label for="sel1">Mata Kuliah</label>
                                            <input class="form-control" id="text3" type="text" name="matkul" />
                                            </select>
                                        </div>
                                        <div class="mb-3">
                                            <label for="text3" class="form-label">Program Studi</label>
                                            <input class="form-control" id="text3" type="text" name="prodi" />
                                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <input style="background-color: #4169E1;" class="btn btn-sm"
                                                            type="submit" value="Simpan" name="input" />
