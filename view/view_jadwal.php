  ...
  <main class=" d-flex">
    ...
    <div class="container-fluid">
      ...
      <div class="container bg-sidebar">
        ...
        <h4 class="text-white" style="margin-left: 10px;">Jadwal Mata Kuliah</h4>
        <a href="add_jadwal.php" class="btn btn-light a-x"><!--position-absolute top-0 start-0 ms-5 mt-2-->
        ...
        <!-- box list --> 
        <br>
        <table class="table-x table-bordered border-dark">
          <thead>
          ...
          <tbody>
            ...
            $nomor = 1;
            $data = mysqli_query($connect, "SELECT * FROM db_add_jadwal");
            while ($db_add_jadwal = mysqli_fetch_array($data)) {
              ?>
              <?php echo "<tr>"; ?>
              <td scope="row">
                <?php echo $nomor++; ?>
              ...
              <?php
              echo "<td>" . $db_add_jadwal['hari'] . "</td>";
              echo "<td>" . $db_add_jadwal['waktu'] . "</td>";
              echo "<td>" . $db_add_jadwal['ruang'] . "</td>";
              echo "<td>" . $db_add_jadwal['matkul'] . "</td>";
              echo "<td>" . $db_add_jadwal['prodi'] . "</td>";
              echo "<td>"; ?>
              <a class="border btn btn-light" href="edit_jadwal.php?id=<?php echo $db_add_jadwal['id']; ?>"><i
                  class="bi bi-pencil-square"></i>
              </a><a class="border btn btn-light" href="delete_jadwal.php?id=<?php echo $db_add_jadwal['id']; ?>"><i
                  class="bi bi-trash"></i>
              </a>
              </td>
              </tr>
