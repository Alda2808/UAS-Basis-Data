        ...
        <div class="container-fluid">
            <div class="container bg-sidebar mt-2">
                <nav class="navbar bg-blue">
                    <a class="close">
                        <a href="file:///Users/apple/Documents/copy/halaman%20utama.html"><img
                    ...
                    <div id="headerrps" class="container tab-pane active"><br>
                        <div class="container">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="ctrl_add_mt.php" method="POST">
                                        <div class="my-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="metode_pembelajaran" id="sel1">
