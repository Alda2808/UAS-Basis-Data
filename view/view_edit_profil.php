  ...
  <main class=" d-flex">
    ...
    <div class="container-fluid">
      ...
      <div class="container bg-sidebar">
        ...
        <h4 class="text-white" style="margin-left: 10px;">Edit Profil</h4>
        </nav>

        <!-- box list --> 
        <br>
        
        <form action="ctrl_foto.php"  method="post" enctype="multipart/form-data">
        <nav class="navbar bg-secondary" style="margin-top: 10px; background-color: #bdbebd;">
        <h5 class="text-white" style="margin-left: 10px;">Profil Foto Dosen</h5>
        </nav>

        <nav style="background-color: #D3D3D3;">
        <br>
        <h5 style="margin-left: 10px;">Upload Foto Profil</h5>
        <br>
        <strong class="f-12" style="margin-left: 10px;">File Foto</strong>
        <input type="file" file-model="myFile" class="form-control f-14" style="margin-left: 10px; width: 98%;">
        <br>

        <button type="submit" name="submit" class="btn btn-success" style="margin-left: 20px;">Simpan Profil</button>
        <button type="submit" name="submit" class="btn btn-primary btn-block">Hapus Profil</button>
          <br>
        </nav>
        </form>
